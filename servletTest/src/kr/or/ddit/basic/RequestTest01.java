...
public class RequestTest01 extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      out.println("</table>");
      out.println("<hr>");
      out.println("<h2>request객체 기타 메서다 결과</h2>");
      out.println("<table border='1'><tr><td>");
      out.println("1. 클라이언트의 IP주소 : " + request.getRemoteAddr() + "<br>");
      out.println("2. 요청메서드 : " + request.getMethod() + "<br>");
      ...
      out.println("<ul>");
      while (params.hasMoreElements()) {	//다음번째에 데이터가 있는지 확인(있으면 true, 없으면 false)
      ...
      //	이  Map객체의 key값은 '파라미터명'미여 자료형은 String이고, value값은 해당 파라미터의 '값'이며 자료형은 String[]이다.
